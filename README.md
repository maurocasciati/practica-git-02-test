...
Vamos a usar este ejemplo básico para ver cómo pueden ocurrir conflictos al trabajar en un repositorio colaborativo y cómo podemos resolverlos

## Primer ejemplo: 
### Integrantes por funcionalidad del TP World Cup
